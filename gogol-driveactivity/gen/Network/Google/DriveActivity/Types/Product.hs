...
-- \"2016-01-10T01:02:03-05:00\" - detail.action_detail_case: Uses the
-- \"has\" operator (:) and either a singular value or a list of allowed
-- action types enclosed in parentheses. Examples: -
-- detail.action_detail_case: RENAME - detail.action_detail_case:(CREATE
-- UPLOAD) - -detail.action_detail_case:MOVE
