...
--
-- /See:/ <https://cloud.google.com/secret-manager/ Secret Manager API Reference> for @secretmanager.projects.locations.list@.
module Network.Google.Resource.SecretManager.Projects.Locations.List
    (
    -- * REST Resource
...
-- | A resource alias for @secretmanager.projects.locations.list@ method which the
