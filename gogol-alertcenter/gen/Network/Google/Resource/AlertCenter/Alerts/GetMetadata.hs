...
--
-- /See:/ <https://developers.google.com/admin-sdk/alertcenter/ G Suite Alert Center API Reference> for @alertcenter.alerts.getMetadata@.
module Network.Google.Resource.AlertCenter.Alerts.GetMetadata
    (
    -- * REST Resource
...
-- the customer the alert metadata is associated with. Inferred from the
