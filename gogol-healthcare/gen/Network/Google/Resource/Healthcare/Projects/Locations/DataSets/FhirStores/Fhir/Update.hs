...
-- The resource must contain an \`id\` element having an identical value to
-- the ID in the REST path of the request. On success, the response body
-- will contain a JSON-encoded representation of the updated resource,
-- including the server-assigned version ID. Errors generated by the FHIR
-- store will contain a JSON-encoded \`OperationOutcome\` resource
