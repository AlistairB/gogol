                   ...
                   QueryParam "callback" Text :>
                     QueryParam "alt" AltJSON :>
                       ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Agent
                         :> Post '[JSON] GoogleCloudDialogflowCxV3beta1Agent
...
projectsLocationsAgentsCreate
    :: Text -- ^ 'placParent'
    -> GoogleCloudDialogflowCxV3beta1Agent -- ^ 'placPayload'
    -> ProjectsLocationsAgentsCreate
...
placPayload :: Lens' ProjectsLocationsAgentsCreate GoogleCloudDialogflowCxV3beta1Agent
placPayload
