...
data ProjectsLocationsAgentsEnvironmentsCreate =
  ProjectsLocationsAgentsEnvironmentsCreate'
    ...
    , _plaecPayload :: !GoogleCloudDialogflowCxV3beta1Environment
...
projectsLocationsAgentsEnvironmentsCreate
    :: Text -- ^ 'plaecParent'
    -> GoogleCloudDialogflowCxV3beta1Environment -- ^ 'plaecPayload'
    -> ProjectsLocationsAgentsEnvironmentsCreate
...
plaecPayload :: Lens' ProjectsLocationsAgentsEnvironmentsCreate GoogleCloudDialogflowCxV3beta1Environment
plaecPayload
