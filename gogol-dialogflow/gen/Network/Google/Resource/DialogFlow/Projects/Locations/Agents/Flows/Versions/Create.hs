...
data ProjectsLocationsAgentsFlowsVersionsCreate =
  ProjectsLocationsAgentsFlowsVersionsCreate'
    ...
    , _plafvcPayload :: !GoogleCloudDialogflowCxV3beta1Version
...
projectsLocationsAgentsFlowsVersionsCreate
    :: Text -- ^ 'plafvcParent'
    -> GoogleCloudDialogflowCxV3beta1Version -- ^ 'plafvcPayload'
    -> ProjectsLocationsAgentsFlowsVersionsCreate
...
plafvcPayload :: Lens' ProjectsLocationsAgentsFlowsVersionsCreate GoogleCloudDialogflowCxV3beta1Version
plafvcPayload
  = lens _plafvcPayload
