                 ...
                 QueryParam "uploadType" Text :>
                   QueryParam "callback" Text :>
                     QueryParam "alt" AltJSON :>
                       ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Agent
                         :> Patch '[JSON] GoogleCloudDialogflowCxV3beta1Agent
...
data ProjectsLocationsAgentsPatch =
  ProjectsLocationsAgentsPatch'
    ...
    , _plapPayload        :: !GoogleCloudDialogflowCxV3beta1Agent
    , _plapName           :: !Text
...
-- * 'plapCallback'
projectsLocationsAgentsPatch
    :: GoogleCloudDialogflowCxV3beta1Agent -- ^ 'plapPayload'
    -> Text -- ^ 'plapName'
    -> ProjectsLocationsAgentsPatch
...
plapPayload :: Lens' ProjectsLocationsAgentsPatch GoogleCloudDialogflowCxV3beta1Agent
plapPayload
