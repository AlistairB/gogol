                     ...
                     QueryParam "callback" Text :>
                       QueryParam "alt" AltJSON :>
                         ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Intent
                           :> Post '[JSON] GoogleCloudDialogflowCxV3beta1Intent
...
data ProjectsLocationsAgentsIntentsCreate =
  ProjectsLocationsAgentsIntentsCreate'
    ...
    , _plaicPayload :: !GoogleCloudDialogflowCxV3beta1Intent
...
projectsLocationsAgentsIntentsCreate
    :: Text -- ^ 'plaicParent'
    -> GoogleCloudDialogflowCxV3beta1Intent -- ^ 'plaicPayload'
    -> ProjectsLocationsAgentsIntentsCreate
...
plaicPayload :: Lens' ProjectsLocationsAgentsIntentsCreate GoogleCloudDialogflowCxV3beta1Intent
plaicPayload
