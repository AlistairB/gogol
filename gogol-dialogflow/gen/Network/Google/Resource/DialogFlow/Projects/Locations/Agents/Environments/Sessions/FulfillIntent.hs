...
data ProjectsLocationsAgentsEnvironmentsSessionsFulfillIntent =
  ProjectsLocationsAgentsEnvironmentsSessionsFulfillIntent'
    ...
    , _plaesfiPayload        :: !GoogleCloudDialogflowCxV3beta1FulfillIntentRequest
...
-- * 'plaesfiCallback'
projectsLocationsAgentsEnvironmentsSessionsFulfillIntent
    :: GoogleCloudDialogflowCxV3beta1FulfillIntentRequest -- ^ 'plaesfiPayload'
    -> Text -- ^ 'plaesfiSession'
    -> ProjectsLocationsAgentsEnvironmentsSessionsFulfillIntent
...
plaesfiPayload :: Lens' ProjectsLocationsAgentsEnvironmentsSessionsFulfillIntent GoogleCloudDialogflowCxV3beta1FulfillIntentRequest
plaesfiPayload
