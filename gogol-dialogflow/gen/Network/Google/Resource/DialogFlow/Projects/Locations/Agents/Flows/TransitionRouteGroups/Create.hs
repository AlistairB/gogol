...
data ProjectsLocationsAgentsFlowsTransitionRouteGroupsCreate =
  ProjectsLocationsAgentsFlowsTransitionRouteGroupsCreate'
    ...
    , _plaftrgcPayload :: !GoogleCloudDialogflowCxV3beta1TransitionRouteGroup
...
projectsLocationsAgentsFlowsTransitionRouteGroupsCreate
    :: Text -- ^ 'plaftrgcParent'
    -> GoogleCloudDialogflowCxV3beta1TransitionRouteGroup -- ^ 'plaftrgcPayload'
    -> ProjectsLocationsAgentsFlowsTransitionRouteGroupsCreate
...
-- | The language to list transition route groups for. The field \`messages\`
-- in TransitionRoute is language dependent. If not specified, the agent\'s
...
plaftrgcPayload :: Lens' ProjectsLocationsAgentsFlowsTransitionRouteGroupsCreate GoogleCloudDialogflowCxV3beta1TransitionRouteGroup
plaftrgcPayload
