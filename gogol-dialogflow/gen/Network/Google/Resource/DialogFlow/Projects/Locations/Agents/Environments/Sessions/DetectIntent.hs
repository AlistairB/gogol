...
data ProjectsLocationsAgentsEnvironmentsSessionsDetectIntent =
  ProjectsLocationsAgentsEnvironmentsSessionsDetectIntent'
    ...
    , _plaesdiPayload        :: !GoogleCloudDialogflowCxV3beta1DetectIntentRequest
...
-- * 'plaesdiCallback'
projectsLocationsAgentsEnvironmentsSessionsDetectIntent
    :: GoogleCloudDialogflowCxV3beta1DetectIntentRequest -- ^ 'plaesdiPayload'
    -> Text -- ^ 'plaesdiSession'
    -> ProjectsLocationsAgentsEnvironmentsSessionsDetectIntent
...
plaesdiPayload :: Lens' ProjectsLocationsAgentsEnvironmentsSessionsDetectIntent GoogleCloudDialogflowCxV3beta1DetectIntentRequest
plaesdiPayload
