...
-- * 'plaetpCallback'
projectsLocationsAgentsEntityTypesPatch
    :: GoogleCloudDialogflowCxV3beta1EntityType -- ^ 'plaetpPayload'
    -> Text -- ^ 'plaetpName'
    -> ProjectsLocationsAgentsEntityTypesPatch
...
plaetpPayload :: Lens' ProjectsLocationsAgentsEntityTypesPatch GoogleCloudDialogflowCxV3beta1EntityType
plaetpPayload
  = lens _plaetpPayload
