                   ...
                   QueryParam "uploadType" Text :>
                     QueryParam "callback" Text :>
                       QueryParam "alt" AltJSON :>
                         ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Page :>
                           Patch '[JSON] GoogleCloudDialogflowCxV3beta1Page
...
data ProjectsLocationsAgentsFlowsPagesPatch =
  ProjectsLocationsAgentsFlowsPagesPatch'
    ...
    , _plafppPayload        :: !GoogleCloudDialogflowCxV3beta1Page
    , _plafppName           :: !Text
...
-- * 'plafppCallback'
projectsLocationsAgentsFlowsPagesPatch
    :: GoogleCloudDialogflowCxV3beta1Page -- ^ 'plafppPayload'
    -> Text -- ^ 'plafppName'
    -> ProjectsLocationsAgentsFlowsPagesPatch
...
plafppPayload :: Lens' ProjectsLocationsAgentsFlowsPagesPatch GoogleCloudDialogflowCxV3beta1Page
plafppPayload
  = lens _plafppPayload
