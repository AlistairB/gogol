...
data ProjectsLocationsAgentsEnvironmentsPatch =
  ProjectsLocationsAgentsEnvironmentsPatch'
    ...
    , _plaepPayload        :: !GoogleCloudDialogflowCxV3beta1Environment
    , _plaepName           :: !Text
...
-- * 'plaepCallback'
projectsLocationsAgentsEnvironmentsPatch
    :: GoogleCloudDialogflowCxV3beta1Environment -- ^ 'plaepPayload'
    -> Text -- ^ 'plaepName'
    -> ProjectsLocationsAgentsEnvironmentsPatch
...
plaepPayload :: Lens' ProjectsLocationsAgentsEnvironmentsPatch GoogleCloudDialogflowCxV3beta1Environment
plaepPayload
