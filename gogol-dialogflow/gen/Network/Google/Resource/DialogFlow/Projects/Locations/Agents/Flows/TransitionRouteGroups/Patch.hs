...
-- * 'plaftrgpCallback'
projectsLocationsAgentsFlowsTransitionRouteGroupsPatch
    :: GoogleCloudDialogflowCxV3beta1TransitionRouteGroup -- ^ 'plaftrgpPayload'
    -> Text -- ^ 'plaftrgpName'
    -> ProjectsLocationsAgentsFlowsTransitionRouteGroupsPatch
...
plaftrgpPayload :: Lens' ProjectsLocationsAgentsFlowsTransitionRouteGroupsPatch GoogleCloudDialogflowCxV3beta1TransitionRouteGroup
plaftrgpPayload
