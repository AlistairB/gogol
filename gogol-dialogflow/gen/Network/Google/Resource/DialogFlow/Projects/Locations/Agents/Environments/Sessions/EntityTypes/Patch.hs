...
data ProjectsLocationsAgentsEnvironmentsSessionsEntityTypesPatch =
  ProjectsLocationsAgentsEnvironmentsSessionsEntityTypesPatch'
    ...
    , _plaesetpPayload        :: !GoogleCloudDialogflowCxV3beta1SessionEntityType
    , _plaesetpName           :: !Text
...
-- * 'plaesetpCallback'
projectsLocationsAgentsEnvironmentsSessionsEntityTypesPatch
    :: GoogleCloudDialogflowCxV3beta1SessionEntityType -- ^ 'plaesetpPayload'
    -> Text -- ^ 'plaesetpName'
    -> ProjectsLocationsAgentsEnvironmentsSessionsEntityTypesPatch
...
plaesetpPayload :: Lens' ProjectsLocationsAgentsEnvironmentsSessionsEntityTypesPatch GoogleCloudDialogflowCxV3beta1SessionEntityType
plaesetpPayload
