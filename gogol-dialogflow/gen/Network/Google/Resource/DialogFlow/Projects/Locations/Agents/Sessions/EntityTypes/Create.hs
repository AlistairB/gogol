...
projectsLocationsAgentsSessionsEntityTypesCreate
    :: Text -- ^ 'plaSetcParent'
    -> GoogleCloudDialogflowCxV3beta1SessionEntityType -- ^ 'plaSetcPayload'
    -> ProjectsLocationsAgentsSessionsEntityTypesCreate
...
plaSetcPayload :: Lens' ProjectsLocationsAgentsSessionsEntityTypesCreate GoogleCloudDialogflowCxV3beta1SessionEntityType
plaSetcPayload
