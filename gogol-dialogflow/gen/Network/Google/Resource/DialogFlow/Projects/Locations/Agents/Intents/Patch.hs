                   ...
                   QueryParam "uploadType" Text :>
                     QueryParam "callback" Text :>
                       QueryParam "alt" AltJSON :>
                         ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Intent
                           :> Patch '[JSON] GoogleCloudDialogflowCxV3beta1Intent
...
data ProjectsLocationsAgentsIntentsPatch =
  ProjectsLocationsAgentsIntentsPatch'
    ...
    , _plaipPayload        :: !GoogleCloudDialogflowCxV3beta1Intent
    , _plaipName           :: !Text
...
-- * 'plaipCallback'
projectsLocationsAgentsIntentsPatch
    :: GoogleCloudDialogflowCxV3beta1Intent -- ^ 'plaipPayload'
    -> Text -- ^ 'plaipName'
    -> ProjectsLocationsAgentsIntentsPatch
...
plaipPayload :: Lens' ProjectsLocationsAgentsIntentsPatch GoogleCloudDialogflowCxV3beta1Intent
plaipPayload
