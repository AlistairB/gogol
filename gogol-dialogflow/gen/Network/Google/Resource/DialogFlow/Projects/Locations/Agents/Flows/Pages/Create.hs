                     ...
                     QueryParam "callback" Text :>
                       QueryParam "alt" AltJSON :>
                         ReqBody '[JSON] GoogleCloudDialogflowCxV3beta1Page :>
                           Post '[JSON] GoogleCloudDialogflowCxV3beta1Page
...
data ProjectsLocationsAgentsFlowsPagesCreate =
  ProjectsLocationsAgentsFlowsPagesCreate'
    ...
    , _plafpcPayload :: !GoogleCloudDialogflowCxV3beta1Page
...
projectsLocationsAgentsFlowsPagesCreate
    :: Text -- ^ 'plafpcParent'
    -> GoogleCloudDialogflowCxV3beta1Page -- ^ 'plafpcPayload'
    -> ProjectsLocationsAgentsFlowsPagesCreate
...
plafpcPayload :: Lens' ProjectsLocationsAgentsFlowsPagesCreate GoogleCloudDialogflowCxV3beta1Page
plafpcPayload
  = lens _plafpcPayload
