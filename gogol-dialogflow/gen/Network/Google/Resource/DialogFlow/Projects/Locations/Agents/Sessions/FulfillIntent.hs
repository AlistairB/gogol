...
-- * 'plasfiCallback'
projectsLocationsAgentsSessionsFulfillIntent
    :: GoogleCloudDialogflowCxV3beta1FulfillIntentRequest -- ^ 'plasfiPayload'
    -> Text -- ^ 'plasfiSession'
    -> ProjectsLocationsAgentsSessionsFulfillIntent
...
plasfiPayload :: Lens' ProjectsLocationsAgentsSessionsFulfillIntent GoogleCloudDialogflowCxV3beta1FulfillIntentRequest
plasfiPayload
  = lens _plasfiPayload
