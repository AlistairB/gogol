...
-- * 'plasmiCallback'
projectsLocationsAgentsSessionsMatchIntent
    :: GoogleCloudDialogflowCxV3beta1MatchIntentRequest -- ^ 'plasmiPayload'
    -> Text -- ^ 'plasmiSession'
    -> ProjectsLocationsAgentsSessionsMatchIntent
...
plasmiPayload :: Lens' ProjectsLocationsAgentsSessionsMatchIntent GoogleCloudDialogflowCxV3beta1MatchIntentRequest
plasmiPayload
  = lens _plasmiPayload
