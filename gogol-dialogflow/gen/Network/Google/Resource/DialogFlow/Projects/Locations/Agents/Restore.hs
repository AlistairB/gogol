...
--
-- Restores the specified agent from a ZIP file. Note that all existing
-- intents, intent routes, entity types, pages and webhooks in the agent
-- will be deleted.
--
...
data ProjectsLocationsAgentsRestore =
  ProjectsLocationsAgentsRestore'
    ...
    , _plarPayload        :: !GoogleCloudDialogflowCxV3beta1RestoreAgentRequest
    , _plarName           :: !Text
...
-- * 'plarCallback'
projectsLocationsAgentsRestore
    :: GoogleCloudDialogflowCxV3beta1RestoreAgentRequest -- ^ 'plarPayload'
    -> Text -- ^ 'plarName'
    -> ProjectsLocationsAgentsRestore
...
plarPayload :: Lens' ProjectsLocationsAgentsRestore GoogleCloudDialogflowCxV3beta1RestoreAgentRequest
plarPayload
