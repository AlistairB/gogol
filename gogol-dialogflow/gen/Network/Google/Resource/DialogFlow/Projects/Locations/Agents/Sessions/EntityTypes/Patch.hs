...
data ProjectsLocationsAgentsSessionsEntityTypesPatch =
  ProjectsLocationsAgentsSessionsEntityTypesPatch'
    ...
    , _plaSetpPayload :: !GoogleCloudDialogflowCxV3beta1SessionEntityType
    , _plaSetpName :: !Text
...
-- * 'plaSetpCallback'
projectsLocationsAgentsSessionsEntityTypesPatch
    :: GoogleCloudDialogflowCxV3beta1SessionEntityType -- ^ 'plaSetpPayload'
    -> Text -- ^ 'plaSetpName'
    -> ProjectsLocationsAgentsSessionsEntityTypesPatch
...
plaSetpPayload :: Lens' ProjectsLocationsAgentsSessionsEntityTypesPatch GoogleCloudDialogflowCxV3beta1SessionEntityType
plaSetpPayload
