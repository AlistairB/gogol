                     ...
                     QueryParam "callback" Text :>
                       QueryParam "alt" AltJSON :>
                         ReqBody '[JSON]
                           ...
                           :>
                           Post '[JSON] GoogleCloudDialogflowCxV3beta1EntityType
...
data ProjectsLocationsAgentsEntityTypesCreate =
  ProjectsLocationsAgentsEntityTypesCreate'
    ...
    , _plaetcPayload :: !GoogleCloudDialogflowCxV3beta1EntityType
...
projectsLocationsAgentsEntityTypesCreate
    :: Text -- ^ 'plaetcParent'
    -> GoogleCloudDialogflowCxV3beta1EntityType -- ^ 'plaetcPayload'
    -> ProjectsLocationsAgentsEntityTypesCreate
...
plaetcPayload :: Lens' ProjectsLocationsAgentsEntityTypesCreate GoogleCloudDialogflowCxV3beta1EntityType
plaetcPayload
  = lens _plaetcPayload
