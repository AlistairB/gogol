...
data ProjectsLocationsAgentsExport =
  ProjectsLocationsAgentsExport'
    ...
    , _plaePayload :: !GoogleCloudDialogflowCxV3beta1ExportAgentRequest
    , _plaeName :: !Text
...
-- * 'plaeCallback'
projectsLocationsAgentsExport
    :: GoogleCloudDialogflowCxV3beta1ExportAgentRequest -- ^ 'plaePayload'
    -> Text -- ^ 'plaeName'
    -> ProjectsLocationsAgentsExport
...
plaePayload :: Lens' ProjectsLocationsAgentsExport GoogleCloudDialogflowCxV3beta1ExportAgentRequest
plaePayload
