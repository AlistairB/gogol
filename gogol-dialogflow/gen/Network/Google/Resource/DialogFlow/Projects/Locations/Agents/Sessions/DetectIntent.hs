...
-- * 'plasdiCallback'
projectsLocationsAgentsSessionsDetectIntent
    :: GoogleCloudDialogflowCxV3beta1DetectIntentRequest -- ^ 'plasdiPayload'
    -> Text -- ^ 'plasdiSession'
    -> ProjectsLocationsAgentsSessionsDetectIntent
...
plasdiPayload :: Lens' ProjectsLocationsAgentsSessionsDetectIntent GoogleCloudDialogflowCxV3beta1DetectIntentRequest
plasdiPayload
  = lens _plasdiPayload
