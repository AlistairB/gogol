...
-- +----------------------------------+----------------------------------+
-- | co                               | Replace all custom custom PyPI   |
-- | nfig.softwareConfig.pypiPackages | packages. If a replacement       |
...
-- |                                  | individual package.              |
-- +----------------------------------+----------------------------------+
-- | config.softwareC                 | Update the custom PyPI package   |
-- | onfig.pypiPackages.'packagename' | 'packagename', preserving other  |
-- |                                  | packages. To delete the package, |
-- |                                  | include it in \`updateMask\`,    |
-- |                                  | and omit the mapping for it in   |
-- |                                  | \`environment.confi              |
-- |                                  | g.softwareConfig.pypiPackages\`. |
-- |                                  | It is an error to provide both a |
-- |                                  | mask of this form and the        |
-- |                                  | \"conf                           |
-- |                                  | ig.softwareConfig.pypiPackages\" |
-- |                                  | mask.                            |
-- +----------------------------------+----------------------------------+
...
-- |                                  | error to provide both this mask  |
-- |                                  | and a mask specifying one or     |
-- |                                  | more individual labels.          |
-- +----------------------------------+----------------------------------+
-- | labels.'labelName'               | Set the label named 'labelName', |
-- |                                  | while preserving other labels.   |
-- |                                  | To delete the label, include it  |
-- |                                  | in \`updateMask\` and omit its   |
-- |                                  | mapping in                       |
...
-- +----------------------------------+----------------------------------+
-- | config.softw                     | Replace all Apache Airflow       |
-- | areConfig.airflowConfigOverrides | config overrides. If a           |
-- |                                  | replacement config overrides map |
-- |                                  | is not included in               |
-- |                                  | \`environment\`, all config      |
-- |                                  | overrides are cleared. It is an  |
-- |                                  | error to provide both this mask  |
-- |                                  | and a mask specifying one or     |
-- |                                  | more individual config           |
-- |                                  | overrides.                       |
-- +----------------------------------+----------------------------------+
-- | config.softwareConfig.airflowCo  | Override the Apache Airflow      |
-- | nfigOverrides.'section'-'name  ' | config property 'name' in the    |
-- |                                  | section named 'section',         |
-- |                                  | preserving other properties. To  |
-- |                                  | delete the property override,    |
-- |                                  | include it in \`updateMask\` and |
-- |                                  | omit its mapping in              |
-- |                                  | \`environment.config.software    |
-- |                                  | Config.airflowConfigOverrides\`. |
-- |                                  | It is an error to provide both a |
-- |                                  | mask of this form and the        |
-- |                                  | \"config.softwar                 |
-- |                                  | eConfig.airflowConfigOverrides\" |
-- |                                  | mask.                            |
-- +----------------------------------+----------------------------------+
-- | co                               | Replace all environment          |
-- | nfig.softwareConfig.envVariables | variables. If a replacement      |
-- |                                  | environment variable map is not  |
-- |                                  | included in \`environment\`, all |
-- |                                  | custom environment variables are |
-- |                                  | cleared. It is an error to       |
-- |                                  | provide both this mask and a     |
-- |                                  | mask specifying one or more      |
