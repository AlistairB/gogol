...
accelerator
    :: Accelerator
accelerator = Accelerator' {_aAcceleratorType = Nothing}
...
instance FromJSON Accelerator where
        parseJSON
          = withObject "Accelerator"
              (\ o -> Accelerator' <$> (o .:? "acceleratorType"))
...
-- | A client-specified ID for this binding. Expected to be globally unique
-- to support the internal bindings-by-ID API.
